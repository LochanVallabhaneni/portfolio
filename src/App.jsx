// Running in-browser with UMD React/ReactDOM. Hooks are taken from global React.
                        ...
                        <div key={skill.name} className="skill-item">
                            <div className="progress-bar">
                                <div className="progress-bar-fill" style={{ width: skill.level }}>
                                    <span className="progress-label">{skill.name} — {skill.level}</span>
                                </div>
                            </div>
                        </div>
                    ))}
...
// Expose to window for inline renderer in index.html
window.App = App;